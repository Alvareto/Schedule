...
namespace ScheduleApp.Web.Controllers
{
    public class ShiftsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Shiftdate,IsHoliday")] Shift shift)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Shiftdate,IsHoliday")] Shift shift)
        {
            if (id != shift.Id)
            {
                return NotFound();
